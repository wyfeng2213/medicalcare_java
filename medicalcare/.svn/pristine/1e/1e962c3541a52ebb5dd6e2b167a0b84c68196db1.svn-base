...
<script type="text/javascript">
	$(function(){
		...
		$.ajax({
			type: "post",
            url: "${ctx}/sysChart/getActiveUser.action",
		...
		$.ajax({
			type: "post",
            url: "${ctx}/sysChart/getAddUser.action",
            data: {showType:showType,startTime:startTime,endTime:endTime},
            async:false,
            dataType: "json",
            success: function(data){
...
<hr/>
<div id="platBar0"  style="text-align:center">
	<span>展示方式：</span>
...
<hr/>
<div id="activeUserBar" style="text-align:center">
</div>
<hr/>
<div id="addUserBar" style="text-align:center">
</div>
</body>
</html>