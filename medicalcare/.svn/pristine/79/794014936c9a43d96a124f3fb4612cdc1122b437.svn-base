...
public class ValidationAIUtil {
	...
	public static boolean isIDCard(String IDStr) {
		if (IDStr == null || "".equals(IDStr)) return false;
		try {
			String str = IDCardValidate(IDStr);
			if ("".equals(str)) {
				return true;
			} else {
				return false;
...
////      String IDCardNum = "111111111111111";
//      ValidationAIUtil cc = new ValidationAIUtil();      
//      System.out.println(cc.IDCardValidate(IDCardNum));      
      // System.out.println(cc.isDate("1996-02-29"));     
	  
	  System.out.println(isIDCard("111111111111111"));
  }      
/*********************************** 身份证验证结束 ****************************************/  
}
