...
<link rel="stylesheet" href="${path}/view/wap/css/style_youku_2.css">
...
<body>
	...
	<div class="block_div">
		<img src="${path}/view/wap/images/youku/top_2.png" width="100%" height="100%" alt="" >
	</div>
	<div class="block_div">
	...
	<!-- 办理成功提示框-end -->
	<div class="block_div">
		<img src="${path}/view/wap/images/youku/bottom_2.png" width="100%" height="100%" alt="" >
	</div>
</body>
</html>
