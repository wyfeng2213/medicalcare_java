...
public class Testmain {
    ...
    public static void main(String[] args) {
         ...
         byte kk=1;
        System.out.println(Utils.byteToInt(kk));
        System.out.println(Utils.getInterId());
        //testpayqury();//查询
        testapppay();//支付
       // testrefund();//退款
    }
    ...
    public static void testapppay(){
        String url="http://120.25.71.44:8089/pay/weixinapp/charges";
        //String url="http://localhost:8089/pay/weixinapp/charges";
    ...
    public static void testrefund(){
        //String url="http://120.25.71.44:8089/pay/weixinapp/charges";
        String url="http://localhost:8089/pay/weixinapp/refund";
