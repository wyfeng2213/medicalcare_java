        ...
        <div class="central">
            ...
            <div class="functional">
				...
				<div id="con_one_2" style="display:none"><!-- 业务详情框-end -->
					...
					<span>1、扣费规则：</span>19.99元1G央视咪咕奥运流量包</span>在有效期内限办理1次，仅能通过基本账户进行扣费。<br>					
					<span>2、生效规则：</span>办理立即生效，19.99元咪咕会员流量包有效期7天，流量包内所含流量为省内2/3/4G通用流量。<br>					
					<span>3、并存规则：</span><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1）不限量套餐、4G随心王客户不可办理。如需办理，需先主动取消上述套餐。<br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2）与其他流量套餐可并存。<br>
					<span>4、流量封顶规则：</span>流量包所含流量遵循套外500元、流量15G双封顶，总流量50G封停规则（19.99元不计入套外500元范围内）。<br>
					<span>5、使用周期：</span>在指定期限内流量有效，不受月结日影响，超过指定有效期流量清零。<br>
					<span>6、权益规则：</span>视频权益可通过指定链接观看奥运赛事，视频权益有效期至8月31日24时。
					</div>
				</div>
