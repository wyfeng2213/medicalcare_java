...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title=""
		...
		<form id="doctorRecordQueryForm" method="post"
			...
			<table class="grid">
				...
				<tr>
					...
					<td><input type="datetime" name="createtime" disabled="false"
						...
						value="<fmt:formatDate  value="${doctorRecord.createtime}" pattern="yyyy-MM-dd HH:mm:ss"/>" /></td>
				</tr>
				<tr>
					<td>医生类型:</td>
					<c:choose>
					...
					<c:choose>
						<c:when test="${doctorRecord.graphicConsulting==1}">
							<td><input name="graphicConsulting" type="text"
								disabled="false" class="easyui-validatebox" value="是"></td>
						</c:when>
						<c:otherwise>
							<td><input name="graphicConsulting" type="text"
								disabled="false" class="easyui-validatebox" value="否"></td>
						</c:otherwise>
					</c:choose>
				...
				<tr>
					<td>排序序号:</td>
					<td><input type="text" name="sequence" disabled="false"
