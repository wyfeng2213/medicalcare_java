package com.cmcc.medicalcare.cache;
...
public class MySessionContext {
	...
	public final static int WEB_SECRETARY_SESSION_TYPE = 3;
	...
	private final static String WEB_SECRETARY_SESSION = "WEB_SECRETARY_SESSION_";
	...
	public String getSession(String num,int type){
		...
		}else if(type == WEB_SECRETARY_SESSION_TYPE){
