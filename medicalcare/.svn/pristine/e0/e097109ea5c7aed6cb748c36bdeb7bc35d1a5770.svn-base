/**   
* @Title: DoctorsInterrogationQuestionController.java 
* @Package com.cmcc.medicalcare.controller.app 
* @Description: TODO
* @author adminstrator   
* @date 2017年4月10日 上午11:44:35 
* @version V1.0   
*/
...
*/
@Controller
@RequestMapping("/app/doctorsInterrogationQuestion")
public class DoctorsInterrogationQuestionController extends AppBaseController {
