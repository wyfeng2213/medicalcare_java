/**   
* @Title: DoctorsFollowupPlanTemplateController.java 
* @Package com.cmcc.medicalcare.controller.app 
* @Description: TODO
* @author adminstrator   
* @date 2017年4月10日 上午11:42:23 
* @version V1.0   
*/
...
*/
@Controller
@RequestMapping("/app/doctorsFollowupPlanTemplate")
public class DoctorsFollowupPlanTemplateController extends AppBaseController {
