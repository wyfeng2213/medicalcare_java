...
public class MessageCode {
	 ...
	 * 敏感词消息发送失败
	 */
	public final static int CODE_408 = 408;
	
	/**
	 * 消息发送涉及财产安全
	 */
	public final static int CODE_208 = 208;
	 ...
	 * 执行成功, 但是没有数据 code
	 */
	public final static int CODE_204 = 204;
	
	/**
	 * 执行成功, 但是没有数据 code
	 */
	public final static int CODE_205 = 205;
	 ...
	 * 敏感词
	 */
	public final static int CODE_244 = 244;
	 ...
	 * 敏感词消息发送失败
	 */
	public final static String MESSAGE_408 = "敏感词消息发送失败";
	 ...
	 * 执行成功, 但是没有数据 code
	 */
	public final static String MESSAGE_204 = "执行成功, 但是没有数据";
	
	/**
	 * 执行成功, 但是没有数据 code
	 */
	public final static String MESSAGE_205 = "执行成功, 但是没有数据";
	
	/**
	 * 
	 */
	public final static String MESSAGE_206 = "限制长度";
