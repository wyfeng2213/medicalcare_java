 ...
 */
@Controller
@RequestMapping("/app/doctorsSecretaryLink")
public class DoctorsSecretaryLinkController extends AppBaseController {
	 ...
	 */
	@Override
	public @RequestMapping(value = "insert") @ResponseBody Results<String> insert(HttpServletRequest request) {
	 ...
	 */
	@Override
	public @RequestMapping(value = "select") @ResponseBody Results<String> select(HttpServletRequest request) {
		// TODO Auto-generated method stub
