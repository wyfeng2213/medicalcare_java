...
<link rel="stylesheet" href="${path}/view/wap/css/style_migu_1gyy.css">
...
<body>
	...
	<div class="block_div">
		<img src="${path}/view/wap/images/migu/1gyy_top.png" width="100%" height="100%" alt="" >
	</div>
	<div class="block_div">
		<div class="discount">
			...
			<div class="llth">
				<img src="${path}/view/wap/images/migu/migu_logo.png" width="74" height="74" alt="" >
			</div>
			<div class="l_name">
	...
	<div class="block_div">
		<div class="contentdiv">
			<p>温馨提示：若订购成功后，当时未领取咪咕音乐直播特惠权益，<br>
			可点击下面按钮找回权益！
			</p>
		</div>
	</div>
	...
	<!-- 办理成功提示框-end -->
	<div class="block_div">
		<img src="${path}/view/wap/images/migu/1gyy_bottom.png" width="100%" height="100%" alt="" >
	</div>
</body>
</html>
