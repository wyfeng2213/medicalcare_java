...
<link rel="stylesheet" href="${path}/view/wap/css/style_bestv_2.css">
...
$(function() {  
	...
	var stock = parseInt('${mchtproduct.product.stock}');
	if(productstatus=='0')
	{
		//
	}
	...
	if(stock > 0)
	{
		//$("#idproductstock").html("剩余"+toThousands(stock)+"份");
		var formatstock = toThousands(stock);				
		$("#inputstock").val(formatstock);
	}
	else
	{
		if(stock == -999)
		{
			$("#idproductstock").html('<p>当前库存充足</p>');
		}
		else
		{
			$("#idproductstock").html('<p>对不起，您晚来了，下次早点</p>');
			$("#iddiv_buy").html('<a href="#" class="yes_handle">活动结束</a>');
		}
	}
...
<body>
	...
	<div class="block_div">
		<img src="${path}/view/wap/images/bestv/top_2.jpg" width="100%" height="100%" alt="" >
	</div>
	<div class="block_div">
		<div class="stockdiv" id="idproductstock">
			<span>剩余:<input type="text" class="stockinput" id="inputstock" name="inputstock" value="${mchtproduct.product.stock}" disabled="disabled">份</span>
			<!--
			<p>抢购时间从
			<fmt:formatDate value="${mchtproduct.product.validStartTime}" type="date" dateStyle="long"/>到
			<fmt:formatDate value="${mchtproduct.product.validEndTime}" type="date" dateStyle="long"/>
			</p>
			-->
		</div>
	</div>
	...
	<div class="block_div">
		<div class="discount">
			...
			<div class="l_name">
				...
				<div id="divshowmobile" class="abstract" style="display:block">您的号码为：${mobile}</div>
	...
	<!-- 办理成功提示框-end -->
	<div class="block_div">
		<img src="${path}/view/wap/images/bestv/bottom_2.jpg" width="100%" height="100%" alt="" >
	</div>
</body>
</html>
