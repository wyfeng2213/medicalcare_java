        ...
        <div class="central">
            ...
            <div class="functional">
				...
				<div id="con_one_2" style="display:none"><!-- 业务详情框-end -->
					...
					<span>1、扣费规则：</span>19.99元1G百视通会员流量包在有效期内限办理1次，仅能通过基本账户进行扣费。<br>					
					<span>2、生效规则：</span>办理立即生效，19.99元百视通会员流量包有效期7天，流量包内所含流量为省内2/3/4G通用流量。<br>					
					<span>3、并存规则：</span><br>
					...
					<span>6、权益规则：</span>视频权益可通过BESTV客户端观看VIP精彩内容，视频权益有效期为7天。
					</div>
				</div>
