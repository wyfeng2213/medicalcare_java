/**   
* @Title: PatientReferralController.java 
...
/** 
* @ClassName: PatientReferralController 
* @Description: TODO
* @author adminstrator
* @date 2017年4月10日 上午11:55:17 
*  
*/
@Controller
@RequestMapping("/app/patientReferral")
public class PatientReferralController extends AppBaseController {
