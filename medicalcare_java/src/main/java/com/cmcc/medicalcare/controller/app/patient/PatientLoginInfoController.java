...
public class PatientLoginInfoController {
	...
	@ResponseBody 
	public Results<String> sendCode(HttpServletRequest request, @RequestParam String hPhonenumber, String equipmentData) {
...
//			Map<String,Object> flagMap = EcopUtils.checkValcode(hPhonenumber, code);
			...
			if(true == flag) {
				if (null == patientLoginInfo_) {
					...
					patientLoginInfo.setPatientLoginId(hPhonenumber);
