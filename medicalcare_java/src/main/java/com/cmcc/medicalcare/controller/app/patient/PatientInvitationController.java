/**   
* @Title: PatientInvitationController.java 
* @Package com.cmcc.medicalcare.controller.app 
* @Description: TODO
* @author adminstrator   
* @date 2017年4月10日 上午11:54:13 
* @version V1.0   
*/
...
*/
@Controller
@RequestMapping("/app/patientInvitation")
public class PatientInvitationController extends AppBaseController {
