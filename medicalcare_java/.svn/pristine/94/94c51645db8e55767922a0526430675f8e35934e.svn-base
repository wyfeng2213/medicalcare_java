/**   
* @Title: DoctorsInterrogationTemplateController.java 
* @Package com.cmcc.medicalcare.controller.app 
* @Description: TODO
* @author adminstrator   
* @date 2017年4月10日 上午11:47:07 
* @version V1.0   
*/
 ...
 */
@Controller
@RequestMapping("/app/doctorsInterrogationTemplate")
public class DoctorsInterrogationTemplateController extends AppBaseController {
