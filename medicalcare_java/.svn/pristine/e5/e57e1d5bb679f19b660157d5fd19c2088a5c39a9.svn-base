/**   
* @Title: DoctorsInterrogationQuestionTemplateController.java 
* @Package com.cmcc.medicalcare.controller.app 
* @Description: TODO
* @author adminstrator   
* @date 2017年4月10日 上午11:45:58 
* @version V1.0   
*/
 ...
 */
@Controller
@RequestMapping("/app/doctorsInterrogationQuestionTemplate")
public class DoctorsInterrogationQuestionTemplateController extends AppBaseController {
