/**   
* @Title: PolularScienceController.java 
* @Package com.cmcc.medicalcare.controller.app 
* @Description: TODO
* @author adminstrator   
* @date 2017年4月10日 上午11:56:27 
* @version V1.0   
*/
package com.cmcc.medicalcare.controller.app;
 ...
 */
@Controller
@RequestMapping("/app/polularScience")
public class PolularScienceController extends AppBaseController {
