/**   
* @Title: PatientAppointmentController.java 
* @Package com.cmcc.medicalcare.controller.app 
* @Description: TODO
* @author adminstrator   
* @date 2017年4月10日 上午11:48:56 
* @version V1.0   
*/
...
/** 
* @ClassName: PatientAppointmentController 
* @Description: TODO
* @author adminstrator
* @date 2017年4月10日 上午11:48:56 
*  
*/
@Controller
@RequestMapping("/app/patientAppointment")
public class PatientAppointmentController extends AppBaseController {
	...
	* @param request
	* @return 
	* @see com.cmcc.medicalcare.controller.AppBaseController#insert(javax.servlet.http.HttpServletRequest) 
	*/
	@Override
	...
	* @param request
	* @return 
	* @see com.cmcc.medicalcare.controller.AppBaseController#select(javax.servlet.http.HttpServletRequest) 
	*/
	@Override
